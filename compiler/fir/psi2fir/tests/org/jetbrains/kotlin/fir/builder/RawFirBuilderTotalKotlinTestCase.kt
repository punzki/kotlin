        ...
        for (file in root.walkTopDown()) {
            ...
            psiSetDirect.removeIf {
                it is KtPackageDirective || it is KtImportList || it is KtClassBody ||
                        ...
                        it is KtUserType || it is KtNullableType ||
                        ...
                        // TODO: this should be removed after call type arguments implementation
                        it is KtTypeProjection && it.parent.parent is KtCallExpression ||
